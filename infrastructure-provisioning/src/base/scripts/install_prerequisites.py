...
parser.add_argument('--pip_packages', type=str, default='boto3==1.14.56 argparse fabric==1.14.0 awscli google-api-python-client google-auth-httplib2 google-cloud-storage pycrypto azure==2.0.0 azure-core==1.21.1')
